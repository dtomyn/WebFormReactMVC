...
function g({ apiBaseUrl: e = "" }) {
	let [t, n] = (0, l.useState)([]), [r, i] = (0, l.useState)("loading"), [a, o] = (0, l.useState)(""), s = m(e);
	return (0, l.useEffect)(() => {
		let e = new AbortController();
		return h(s, e.signal).then((e) => {
			n(e), o(""), i("loaded");
		}).catch((e) => {
...
function _(e, t = {}) {
	(0, u.createRoot)(e).render(/* @__PURE__ */ (0, f.jsx)(l.StrictMode, { children: /* @__PURE__ */ (0, f.jsx)(g, { apiBaseUrl: t.apiBaseUrl ?? e.getAttribute("data-api-base-url") ?? "" }) }));
}
function v(e = "[data-people-app]") {
	document.querySelectorAll(e).forEach((e) => {
		e.getAttribute("data-people-mounted") !== "true" && (e.setAttribute("data-people-mounted", "true"), _(e));
	});
}
//#endregion
