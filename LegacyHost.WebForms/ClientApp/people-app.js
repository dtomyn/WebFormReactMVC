...
var e = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function xi(e, t, n, r, i, a) {
		...
		if (r = e, typeof e == "function") vi(e) && (o = 1);
			...
			case ee: return e = _i(13, n, t, i), e.elementType = ee, e.lanes = a, e;
...
function y({ editingPerson: e, formValues: t, isSaving: n, saveErrorMessage: r, nameInputRef: i, onBackdropClick: a, onFieldChange: o, onCancel: s, onSave: c }) {
...
function b({ apiBaseUrl: e = "" }) {
	let [t, n] = (0, l.useState)([]), [r, i] = (0, l.useState)("loading"), [a, o] = (0, l.useState)(""), [s, c] = (0, l.useState)(null), [u, d] = (0, l.useState)({
		name: "",
		role: "",
		location: "",
		email: ""
	}), [g, b] = (0, l.useState)("idle"), [x, S] = (0, l.useState)(""), C = (0, l.useRef)(null), w = m(e, p);
	(0, l.useEffect)(() => {
		let e = new AbortController();
		return h(w, e.signal).then((e) => {
			n(e), o(""), i("loaded");
		}).catch((e) => {
		...
		C.current?.focus();
		let e = (e) => {
			e.key === "Escape" && g !== "saving" && (c(null), S(""));
		};
	...
	async function re() {
		...
		if (Object.values(t).some((e) => e.length === 0)) {
			S("Name, role, location, and email are required.");
			return;
		}
		if (!t.email.includes("@")) {
			S("Email must contain '@'.");
			return;
		}
		b("saving"), S("");
		try {
			let r = await _(m(e, `${p}/${s.id}`), t);
...
function x(e, t = {}) {
	(0, u.createRoot)(e).render(/* @__PURE__ */ (0, f.jsx)(l.StrictMode, { children: /* @__PURE__ */ (0, f.jsx)(b, { apiBaseUrl: t.apiBaseUrl ?? e.getAttribute("data-api-base-url") ?? "" }) }));
}
function S(e = "[data-people-app]") {
	document.querySelectorAll(e).forEach((e) => {
		e.getAttribute("data-people-mounted") !== "true" && (e.setAttribute("data-people-mounted", "true"), x(e));
	});
}
//#endregion
